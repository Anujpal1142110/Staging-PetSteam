          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Facebook"
                className="bg-gray-800 hover:bg-primary-700 transition-colors p-2 rounded-full text-gray-400 hover:text-white"
              >
                <FaFacebookF size={20} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <FaMapMarkerAlt className="mt-1 mr-3 text-primary-500" size={18} />
                <span className="text-gray-400">
                  123 Business Avenue, Industrial Area, New Delhi, India
                </span>
              </li>
              <li className="flex items-center">
                <FaPhone className="mr-3 text-primary-500" size={18} />
                <a href="tel:+919876543210" className="text-gray-400 hover:text-white transition-colors">
                  +91 9876543210
                </a>
              </li>
              <li className="flex items-center">
                <FaEnvelope className="mr-3 text-primary-500" size={18} />
                <a href="mailto:info@petstream.in" className="text-gray-400 hover:text-white transition-colors">
                  info@petstream.in
                </a>
              </li>
            </ul>
