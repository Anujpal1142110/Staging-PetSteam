    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 container mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
          <h1 className="text-4xl font-bold text-white mb-2">Machine Relocation, Installation & Dis-assembly</h1>
...
export default MachineRelocation;