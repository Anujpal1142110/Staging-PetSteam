    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 container mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
          <h1 className="text-4xl font-bold text-white mb-2">Annual Maintenance Contract & Plant Audit</h1>
          ...
          <div className="flex flex-col md:flex-row md:space-x-12">
            ...
            <div className="md:w-1/3">
              <div className="bg-orange-500 p-6">
                <h3 className="text-xl font-bold text-center text-white mb-4">Annual Maintenance Contract & Plant Audit</h3>
                <p className="text-white">
                  You can rely us on for AMC and Plant audit to lower your Maintenance cost and improve your machine OEE.
                </p>
              </div>
            </div>
          </div>
