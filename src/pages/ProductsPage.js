...
const ServicesAndProductsPage = () => {
  ...
  return (
    <>
      {/* <Helmet>
        <title>{companyData.name} - Services & Products</title>
        <meta name="description" content="Explore our comprehensive range of services and products for the beverage, packaging, healthcare, and plastics industries." />
      </Helmet> */}
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Comprehensive solutions and world-class equipment for the beverage, packaging, healthcare, and plastics industries.
          </p>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Contact us today to discuss how our services and products can help you achieve greater efficiency 
