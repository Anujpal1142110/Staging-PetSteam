      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto opacity-90">
            Reach out to us for inquiries, service requests, or to discuss how we can help optimize your manufacturing operations.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Whether you're after a machine, spare part, power tool, or need to book a service call PSI will help you find the right solution in a timely manner.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-lg p-8 transform hover:scale-105 transition-all duration-300">
              <div className="mb-6">
                <h3 className="text-xl font-bold text-blue-900 mb-1">PET Stream Inc.</h3>
                <h4 className="text-lg font-semibold text-blue-700">Corporate Office:</h4>
              </div>
              <div className="space-y-4">
                <div className="flex items-start group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 mt-1 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <p className="text-gray-700">Office No. 1603A & 1603B, 16th floor, The Iconic Tower, Corenthum, Sector -62, Noida, National Capital Region, India-201309</p>
                </div>
                <div className="flex items-center group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:+919811206119" className="text-gray-700 hover:text-blue-600">+91-98112 06119</a>
                </div>
                <div className="flex items-center group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:ravi.bansal@petstream.in" className="text-gray-700 hover:text-blue-600">ravi.bansal@petstream.in</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-lg p-8 transform hover:scale-105 transition-all duration-300">
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-blue-700">Head Office:</h4>
              </div>
              <div className="space-y-4">
                <div className="flex items-start group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 mt-1 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-700">Office No 206, 2nd floor, Vardhman capital complex, L.S.C Gulabi bagh, Delhi,India- 110052</p>
                </div>
                <div className="flex items-center group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:+919811906119" className="text-gray-700 hover:text-blue-600">+91-98119 06119</a>
                </div>
                <div className="flex items-center group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:info@petstream.in" className="text-gray-700 hover:text-blue-600">info@petstream.in</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-lg p-8 transform hover:scale-105 transition-all duration-300">
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-blue-700">Registered Office:</h4>
              </div>
              <div className="space-y-4">
                <div className="flex items-start group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 mt-1 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-700">Office no 7255/77A, Ajendra Market, Ground Floor, Shakti Nagar, Delhi-110007(INDIA)</p>
                </div>
                <div className="flex items-center group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:+919811906119" className="text-gray-700 hover:text-blue-600">+91-9811906119</a>
                </div>
                <div className="flex items-center group">
                  <svg className="w-6 h-6 text-blue-600 mr-3 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:manish.kaushik@petstream.com" className="text-gray-700 hover:text-blue-600">manish.kaushik@petstream.com</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <div className="container mx-auto px-4">
    <div className="text-center mb-16">
      <h4 className="text-2xl text-gray-800 mb-4 font-medium">
        Contact details of your leading specialists from Team PSI for sales and service - domestic & overseas
      </h4>
    </div>
        ...
        {[
          ...
          <div key={index} className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 text-center">
              <h4 className="text-lg font-bold text-red-600 mb-2">{member.name}</h4>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-center">
                  <a href={`mailto:${member.email}`} className="hover:opacity-80">
                    <img 
                      src={mailIcon} 
                      alt="mail" 
                      className="w-8 h-8"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:max-w-[66.67%] md:mx-auto mb-16">
        {[
          ...
          },
          {
            ...
            position: "Service Head – Injection Molding & Lab Equipment Division",
            phone: "+91 9811906197",
            image: Avinash,
          ...
          <div className="sticky top-32">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-700">Instant response within 24 hours</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                  <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-700">Quick consultation booking</span>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="Spare Parts And Services">Spare Parts And Services</option>
                    </select>
              ...
              <div className="flex items-center justify-center gap-6">
                <button
                  ...
                  className={`px-12 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold rounded-xl shadow-lg hover:shadow-orange-500/25 focus:outline-none focus:ring-4 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-300 ${
                    isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:transform hover:-translate-y-1'
                  }`}
                >
                  {isSubmitting ? (
                    <div className="flex items-center">
